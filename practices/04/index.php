...
<?php } ?>
    ...
    <tr>
        <th>お問い合わせ種別</th>
        <td>
        	<input type="radio" name="c" class="yRadio" value="0" checked> ご意見
        	<input type="radio" name="c" class="yRadio" value="1" > ご質問
        </td>
    </tr>
    <tr>
        <th><span>*</span> お名前</th>
    ...
    <tr>
        <th class="for-question"><span>*</span> ご質問内容</th>
        <th class="for-opinion"><span>*</span> ご意見内容</th>
    ...
    <tfoot>
        <td colspan="2">
            ...
            <input type="submit" value="送信" onClick="disp()">
